...
/** 
 * This class fetches data based on a specified CoreData request for the table view and updates it automatically
 * after changes in the CoreData database.
 */
@interface CoreDataTableViewController : NSObject <NSFetchedResultsControllerDelegate>
...
/** To be used for implementation of the corresponding method of UITableViewDataSource. */
